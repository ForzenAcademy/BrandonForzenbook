...
import com.brandon.appjava.data.ForzenEntityJava;
...
public class LoginRepoImplJava implements LoginRepoJava {
    ...
    private static final String DATABASE_ERROR_ACCESS = "Error Accessing Database.";
    ...
    public void getToken(String email, String code) throws Exception {
        ...
        try {
            forzenDaoJava.deleteToken();
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(DATA_ERROR_TAG, DATABASE_ERROR_ACCESS + e);
            throw new Exception(DATABASE_ERROR_ACCESS);
        }
        try {
