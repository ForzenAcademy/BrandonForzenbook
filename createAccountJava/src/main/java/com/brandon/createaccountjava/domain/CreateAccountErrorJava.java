...
public class CreateAccountErrorJava {
    ...
    public boolean equals(Object o) {
        ...
        return firstNameError == that.firstNameError
                && lastNameError == that.lastNameError
                && emailError == that.emailError
                && locationError == that.locationError
                && dateOfBirthError == that.dateOfBirthError
                && connectionErrors == that.connectionErrors
                && state == that.state;
    }
